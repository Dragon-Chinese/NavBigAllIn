...
(this, function (e) {
    ...
    //sessionStorage.setItem(localStorage.getItem("k")+sessionStorage["curSelectedCode"],"false");
    function c(e) {
        return void 0 === e ? "" : "string" == typeof e ? e : e.message
    }

    function filterArr(arr, value) {
        var obj = {c: [], o: [], h: [], l: [], v: [], t: [], s: 'no'};
        obj["h"]=arr.response.high;
        obj["l"]=arr.response.low;
        obj["v"]=arr.response.volume;
        obj["o"]=arr.response.openingPrice;
        obj["c"]=arr.response.closingPrice;
        obj["t"]=arr.response.time;
        obj.s = value;
        if(!obj["h"].length){
            obj.s = 'no_data';
        }else{
    ...
    var i = function () {
        ...
        return e.prototype.getBars = function (e, t, r, s) {
            var o = this;
            var currentCionCode = localStorage.getItem('currentCoinCode');
            i = {code: currentCionCode || "", kLineType: t, startTime: r, endTime: s};
        ...
        return e.prototype.subscribeBars = function (e, t, r, s) {
            ...
            var r = this, e = this._subscribers[t], s = parseInt((Date.now() / 1e3).toString()),
                o = s - function (e, t) {
                    var r = 0;
                    r = "D" === e || "1D" === e ? t : "M" === e || "1M" === e ? 31 * t : "W" === e || "1W" === e ? 7 * t : t * parseInt(e) / 300;
                    return 24 * r * 60 * 60
                }(e.resolution, 10);
    ...
    var o = function () {
        function e(e, t, r, s) {
            ...
            this._configuration = {
                ...
                e = JSON.parse(e.result.replace(/'/g, "\""));
                null === e && (e = {
                    supports_search: !0,
                    supports_group_request: !1,
                    supported_resolutions: ["1", "5", "15", "30", "60", "1D", "1W", "1M"],
